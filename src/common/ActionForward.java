package common;
//ActionForward  클래스는 Action 인터페이스에서 명령을 수행하고 결과값을
//가지고 포워딩 할 떄 사용되는 클래스 입니다.
//이 클래스는 Redirect 여부 값과 포워딩할 페이지의 위치를 가지고 있습니다.
//이 값들은 FrontController에서 ActionForward 클래스 타입으로 반환값을
//가져 오면 그 값을 확인하여 해당하는 요청 페이지로 포워딩 처리를 합니다.
...
public class ActionForward {
	...
	public boolean isRedirect() {
		//프로퍼티 타입이 boolean이 경우 get 대신 is를 앞에 붙일 수 있습니다.
		return redirect;
	}
