...
<%
	Resume res = (Resume)request.getAttribute("resumedata");
...
<body>
	<jsp:include page="../../eu/euheader.jsp"></jsp:include>
	<div id="pviewwrap">
		<div id="pview">
			...
			<div id="certname" style="font-size: 20px; color: gray;">
				...
				<div>${resumedata.CERTNAME}
					&nbsp;<a style="font-size: 14px; color: gray;">${resumedata.PUBLISHER}</a></a>
				</div>
			</div>
			...
			<div style="padding: 20px;">
				<button id="but" value="목록" onclick="history.back();">목록
			</div>
