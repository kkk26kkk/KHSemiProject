...
function onback(){
	alert("이전페이지로 돌아갑니다.");
	location.href="entreviewlist.guuser";
}
...
<body>
	<h3>기업리뷰 수정 페이지 입니다</h3><br>
	<jsp:include page="../../header.jsp" /> 
	<form action="./entreviewUpdate.guentreview" method="post">
	<%-- 일반회원 ID:<input type="text" name="GID" value="${gid}">
	 --%>
	
	<h1 style="text-align:center; font-size:50px;"> 기업리뷰수정 </h1>
	...
	<input type="text" name="ENAME" value="${vo.ENAME }" placeholder="기업명을 입력하세요">
	<br>
	<br> 
<h1>근무조건</h1>
   <hr class="hr">
<br>
 ...
 <label><span id="b">●</span><b>산업</b><br></label><br>
   ...
   <div class="CAREER3"><input type="radio" name=CAREER value="신입" >신입   
		  <input type="radio" name=CAREER value="경력" checked>경력
		</div><br>
...
<option value="제주특별자치도"<c:if test="${vo.REGION=='제주특별자치도'}">
   ...
   <div class="POINT1"><input type="number" name="POINT" 
		 value="${vo.POINT}" min="1" max="10" step="1">점</div><br>

<label><span id="a">★</span><b>한줄평</b><br></Label><br>
<input type="text" name="THINK" value="${vo.THINK }"  placeholder="한줄평을입력하세요"><br>


<label><span id="a">★</span><b>장점</b><br></Label><br>
<input type="text" name="ADV" value="${vo.ADV }" placeholder="장점을입력하세요"><br>

<label><span id="a">★</span><b>단점</b><br></Label><br>
<input type="text" name="DADV" value="${vo.DADV }" placeholder="단점을입력하세요" ><br>

<label><span id="a">★</span><b>못다한이야기</b><br></Label><br>
   <div class="STORY1">
   <textarea name="STORY" cols="45" rows="15" >${vo.STORY }</textarea></div>
		<br><br>
		<hr class="hr">	
